import svgPaths from "./svg-0jgc80wny0";
...
export default function Resources() {
  return (
    <div className="bg-white relative size-full" data-name="Resources">
        ...
        <div className="content-center flex flex-wrap gap-[0px_24px] items-center overflow-clip p-[32px] relative rounded-[inherit] w-full">
          ...
          <div className="content-start flex flex-[1_0_0] flex-wrap gap-[8px] items-start justify-end min-h-px min-w-px relative" data-name="Navigation Pill List">
            ...
            <a className="content-stretch cursor-pointer flex items-center justify-center p-[8px] relative rounded-[8px] shrink-0" data-name="Navigation Pill" href="https://chatbot-37tx6ldxlh6gzz4od3t5oa.streamlit.app/">
              <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#1e1e1e] text-[16px] text-left whitespace-nowrap" role="link" tabIndex="0">
      ...
      <div className="absolute bg-[#ddfdfe] h-[362px] left-0 top-[1119px] w-[985px]" data-name="Footer">
      ...
      <div className="absolute bg-[#fdfbd4] content-stretch flex flex-col gap-[48px] items-start left-[-3px] p-[64px] top-[551px] w-[988px]" data-name="Card Grid Content List">
        <Cards />
      </div>
      <a className="absolute bg-[#e3e3e3] cursor-pointer left-[85px] rounded-[8px] top-[720px]" data-name="Button" href="https://docs.google.com/forms/d/e/1FAIpQLSfPoOqW7dcyrI2l1v30e78-RnP04WlRQaAgeYqIPd7P0JNlRA/viewform?usp=dialog">
